...
<div class="container">
    ...
    <form class="m-5" id="contactForm"  method="post" action="../functions/cadastroprodutos.php">
        ...
        <div class="col form-row">
            <input type="text" id="preco_compra" name="preco_compra" action="../functions/exibicao.php" class="form-control" placeholder="Preco de Compra">
            <div class="invalid-feedback" data-sb-feedback="preco_compra:required">A message is required.
            </div>
        </div>
        <div class="col form-row" >
            <input type="text" name="preco_venda" id="preco_venda" class="form-control"  action="../functions/exibicao.php" placeholder="Preco de Venda">
        ...
        <div  class="form-floating mb-3">
            <select name="categorias" id="categorias" class="form-control"  placeholder="categorias">
                ...
                <label for="categorias">Categoria dos Produtos</label>
            <div class="invalid-feedback" data-sb-feedback="categorias:required">A message is required.
            </div>
        </div>
        </div>
